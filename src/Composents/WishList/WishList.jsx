...
export default function WishList() {
  ...
  const { addProductToCard, DeleteWishList, getWishList } =
...
if (isLoading) {
  return <p className="text-center text-gray-700 font-semibold text-2xl py-10">Loading...</p>;
}
  ...
  return (
    <>
      <div className="relative  overflow-res-auto shadow-md sm:rounded-lg">
        ...
        </table>:<h3 className="text-center text-gray-700 font-semibold text-2xl py-10">Your wishlist is empty <i className="fa-solid fa-face-sad-tear"></i></h3>}
